...
\card
{
	...
	mana_cost = \MTGsymbol{G}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{1}{3} \\
...
\mfcard
{
	...
	front_description = {Lifelink\\
		...
		Disturb \MTGsymbol{2}{3}\MTGsymbol{W}{3}\MTGsymbol{U}{3} },
...
\card
{
	...
	description = {All morph costs cost \MTGsymbol{2}{3} more. },
	stax_type = 其他特殊动作锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{1}{3}\MTGsymbol{U}{3}\MTGsymbol{U}{3} \\
...
\card
{
	...
	description = {Enchant creature\\
		Cumulative upkeep \MTGsymbol{R}{3} \\
...
\card
{
	...
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{U}{3} \\
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep—Pay \MTGsymbol{B}{3} and 1 life. \\
...
\card
{
	...
	description = {死冥耶夫的力量等同于所有坟墓场中的生物牌数量。\\
		在每位牌手的维持开始时，该牌手弃一张牌。\\
		疯魔\MTGsymbol{1}{3}\MTGsymbol{B}{3}\MTGsymbol{B}{3}},
	stax_type = 手牌Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	card_type = Artifact,
	description = {Cumulative upkeep \MTGsymbol{3}{3} \\
...
\mfcard
{
	...
	front_description = {当不稳雕符桥进战场时，若它经你施放，则为每位牌手各选择一个由其操控且力量等于或小于2的生物。然后消灭所有生物，但以此法选中的生物除外。\\
		以神器化炼\MTGsymbol{3}{3}\MTGsymbol{W}{3}\MTGsymbol{W}{3}},
...
\card
{
	...
	description = {在每位牌手的维持开始时，该牌手失去1点生命且弃一张牌。\\
		...
		疯魔\MTGsymbol{2}{3}\MTGsymbol{B}{3}\MTGsymbol{B}{3}},
	stax_type = 手牌Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{2}{3} \\
...
\card
{
	...
	description = {Trample\\
		...
		Suspend 6—\MTGsymbol{1}{3}\MTGsymbol{R}{3}\MTGsymbol{W}{3} },
	stax_type = 攻击/格挡锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
