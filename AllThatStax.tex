...
\mfcard
{
	...
	front_mana_cost = \MTGsymbol{B}{5},
	front_card_type = Legendary Creature — Vampire Warlock,
	front_description = {Menace, lifelink\\
		If a nontoken creature an opponent controls would die, exile it instead. When you do, you may pay \MTGsymbol{2}{3}. If you do, create a 1/1 black and green Pest creature token with "When this creature dies, you gain 1 life."},
	...
	back_mana_cost = \MTGsymbol{2}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	back_card_type = Legendary Creature — Human Druid,
	back_description = {Whenever you gain life, you may pay \MTGsymbol{1}{3}. If you do, put a +1/+1 counter on each creature you control and those creatures gain trample until end of turn.},
	stax_type = 坟墓场Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {如果某个由对手操控的生物将死去，则改为将它放逐。\\
		\MTGsymbol{2}{3}，\MTGsymbol{T}{3}，牺牲埃瑞赫的黑石：放逐目标牌手的坟墓场。抓一张牌。},
	stax_type = 坟墓场Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {每当任一牌手施放咒语，若施放它时未支付过法术力，则反击该咒语。\\
		\MTGsymbol{1}{3}，\MTGsymbol{T}{3}，牺牲乱心饰品：抓一张牌。},
	stax_type = 咒语锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{G}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{1}{3} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)\\
		Black creatures can't attack you.\\
		Nonblack creatures can't attack you unless their controller pays \MTGsymbol{2}{3} for each creature they control that's attacking you.},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{B}{5},
	card_type = 生物 ～昆虫,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{R}{5},
	card_type = 生物 ～吸血鬼,
	description = {先攻\\
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{G}{5},
	card_type = 生物 ～奥夫,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～人类／僧侣,
	description = {闪现\\
...
\card
{
	...
	description = {由对手操控的神器须横置进战场。\\
		\MTGsymbol{X}{3}\MTGsymbol{X}{3}\MTGsymbol{W}{3}，牺牲不屈拆械人：消灭所有法术力值为X的神器。},
	stax_type = 眠梦法球效应,
	is_in_restricted_list = Not RL,
...
\card
{
	...
	mana_cost = \MTGsymbol{B}{5}\MTGsymbol{B}{5},
	card_type = 生物 ～道西／浪客,
	description = {次元幽影（此生物只能阻挡具次元幽影异能的生物，亦只能被具此异能的生物阻挡。）\\
		如果某牌将从任何区域进入对手的坟墓场，则改为将它放逐并在其上放置一个虚空指示物。\\
		\MTGsymbol{T}{3}，牺牲道西虚空行者：选择一张由对手拥有、已放逐且其上有虚空指示物的牌。本回合中，你可以使用它，且不需支付其法术力费用。},
	stax_type = 坟墓场Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\mfcard
{
	...
	front_mana_cost = \MTGsymbol{W}{5}\MTGsymbol{U}{5},
	front_card_type = Legendary Creature — Human Soldier,
	front_description = {Lifelink\\
		Cards in graveyards can't be the targets of spells or abilities.\\
		Disturb \MTGsymbol{2}{3}\MTGsymbol{W}{3}\MTGsymbol{U}{3} (You may cast this card from your graveyard transformed for its disturb cost.)},
	...
	back_description = {Flying\\
		Whenever one or more creature cards are put into graveyards from anywhere, investigate. This ability triggers only once each turn. (Create a Clue token. It's an artifact with "\MTGsymbol{2}{3}, Sacrifice this artifact: Draw a card.")\\
...
\card
{
	...
	card_type = 结界生物 ～精怪,
	description = {先攻\\
		由对手操控之鹏洛客的忠诚异能增加\MTGsymbol{1}{3}来起动。},
	stax_type = 起动式异能税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\mfcard
{
	...
	front_mana_cost = \MTGsymbol{1}{5}\MTGsymbol{U}{5},
...
\card
{
	...
	description = {All morph costs cost \MTGsymbol{2}{3} more. (This doesn't affect the cost to cast creature spells face down.)},
	stax_type = 其他特殊动作锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{G}{5}\MTGsymbol{W}{5},
	card_type = 传奇生物～洁英／参谋,
	description = {不能使用总法术力费用大于或等于4的非生物咒语。\\
		不能使用法术力费用中包括\MTGsymbol{X}{3}的非生物咒语。},
	stax_type = 咒语锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 生物 — 人类／僧侣,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5},
	card_type = 传奇生物～精怪,
	description = {所有神器具有「在你的维持开始时，除非你支付\MTGsymbol{1}{3}，否则牺牲此神器。」},
	stax_type = 大礼拜堂/烟囱效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {威慑（此生物只能被两个或更多生物阻挡。）\\
		所有对手都不能获得生命。\\
		\MTGsymbol{1}{3}\MTGsymbol{B}{3}：暮影骑士得+1/+1直到回合结束。},
	stax_type = 获得生命锁,
	is_in_restricted_list = Not RL,
	legality / standard = legal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{W}{5}\MTGsymbol{U}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～猫／僧侣,
	description = {牌手不能搜寻牌库。任意牌手可以支付\MTGsymbol{2}{3}来让该牌手忽略此效应直到回合结束。},
	stax_type = 搜寻牌库锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{W}{5}\MTGsymbol{B}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～食人魔／精怪,
	description = {对每个生物而言，除非其操控者为其支付\MTGsymbol{1}{3}，否则它不能攻击由你操控的鹏洛客。\\
		\MTGsymbol{4}{3}\MTGsymbol{W}{3}\MTGsymbol{W}{3}，从你的坟墓场放逐欧纳克守誓魔：将目标鹏洛客牌从你的坟墓场移回战场。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{R}{5}\MTGsymbol{R}{5},
	card_type = 生物～元素／祭师,
...
\card
{
	...
	card_type = 生物 ～精怪／僧侣,
	description = {飞行\\
		每当一个触发式异能因永久物进战场而触发时，除非其操控者支付\MTGsymbol{2}{3}，否则反击之。},
	stax_type = ETB锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5},
	card_type = Artifact,
	description = {Flashback costs you pay cost \MTGsymbol{2}{3} less.\\
		Flashback costs your opponents pay cost \MTGsymbol{2}{3} more.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5},
	card_type = 神器,
	description = {如果横置某个地以产生两点或更多法术力，则它改为产生\MTGsymbol{C}{3}，而非其他类别和数量。\\
		牌手施放的咒语增加若干费用来施放，其数量为「该牌手本回合每施放过一个其他咒语，便需增加\MTGsymbol{1}{3}」。},
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5},
	card_type = 神器,
	description = {每个咒语均增加\MTGsymbol{3}{3}来施放，但于其操控者的回合中除外。},
	stax_type = 止咒高僧效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5},
	card_type = Artifact,
	description = {Spells cost \MTGsymbol{1}{3} more to cast.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5},
	card_type = 神器,
	description = {非生物咒语增加\MTGsymbol{1}{3}来施放。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5},
	card_type = 结界,
	description = {敲诈（每当你施放咒语时，你可以支付\MTGsymbol{W/B}{3}。若你如此作，则每位对手各失去1点生命，且你获得等量的生命。）\\
		由对手操控的神器与生物须横置进战场。},
	stax_type = 眠梦法球效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Red spells cost \MTGsymbol{2}{3} more to cast.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {每位牌手每回合所施放的咒语不能多于一个。\\
		\MTGsymbol{4}{3}\MTGsymbol{R}{3}，牺牲日正当中：它对任意一个目标造成5点伤害。},
	stax_type = 依法治理效应,
	is_in_restricted_list = Not RL,
	legality / standard = legal,
	legality / alchemy = legal,
...
\card
{
	...
	description = {结附于对手\\
		...
		在所结附之对手回合的战斗开始时，该牌手可以为每个由其操控的神器各支付\MTGsymbol{1}{3}。若其未如此作，则生物本次战斗不能攻击。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{B}{5}\MTGsymbol{R}{5},
	card_type = 结界,
...
\card
{
	...
	description = {Players skip their untap steps.\\
		At the beginning of your upkeep, sacrifice Stasis unless you pay \MTGsymbol{U}{3}.},
	stax_type = 阶段/步骤锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5},
	card_type = 结界,
	description = {除了法术力异能之外，起动式异能的费用增加\MTGsymbol{2}{3}来使用。},
	stax_type = 起动式异能税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{W}{5}\MTGsymbol{B}{5}\MTGsymbol{G}{5},
	card_type = 传奇生物～人类／士兵,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～统领,
	description = {飞行\\
		每位牌手每回合所施放的咒语不能多于一个。\\
		由对手操控的非基本地须横置进战场。},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 生物 — 鸟／浪客,
	description = {闪现\\
		飞行\\
		当阻咒艾文进战场时，放逐目标咒语。它成为已设谋。（过了该回合后，其拥有者便可于法术时机施放之，且不需支付其法术力费用。）\\
		对手从坟墓场或放逐区中施放的咒语增加\MTGsymbol{2}{3}来施放。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = legal,
	legality / alchemy = legal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{G}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{B}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{R}{5},
	card_type = 生物 ～恐龙／野兽,
	description = {践踏\\
		牌手不能获得生命。},
	stax_type = 获得生命锁,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5},
	card_type = Creature — Human Cleric,
	description = {Noncreature spells cost \MTGsymbol{1}{3} more to cast.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{B}{5},
	card_type = 传奇生物 ～人类／参谋,
	description = {所有对手都不能获得生命。\\
		\MTGsymbol{T}{3}，牺牲另一个生物：目标牌手失去1点生命。如果所牺牲的生物是传奇，则囤兵半兽人2。},
	stax_type = 获得生命锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5},
	card_type = 生物 ～人鱼／海盗,
	description = {闪现\\
		如果某对手将抓一张牌，且这不是其于自己的每个抓牌步骤中所抓的第一张牌，则改为你派出一个珍宝衍生物。（珍宝衍生物是具有「\MTGsymbol{T}{3}，牺牲此神器：加一点任意颜色的法术力」的神器。）},
	stax_type = 抓牌锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{G}{5}\MTGsymbol{W}{5},
	card_type = 传奇生物 — 猫／战士,
...
\card
{
	...
	mana_cost = \MTGsymbol{B}{5}\MTGsymbol{G}{5}\MTGsymbol{U}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
...
\card
{
	...
	description = {At the beginning of your upkeep, sacrifice Peacekeeper unless you pay \MTGsymbol{1}{3}\MTGsymbol{W}{3}.\\
...
\card
{
	...
	mana_cost = \MTGsymbol{U}{5}\MTGsymbol{R}{5}\MTGsymbol{W}{5},
...
\mfcard
{
	...
	front_mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5},
	front_card_type = Legendary Creature — God,
	front_description = {Flying, vigilance\\
		Snow lands your opponents control enter tapped.\\
		Noncreature spells your opponents cast with mana value 4 or greater cost \MTGsymbol{2}{3} more to cast.},
	...
	back_mana_cost = \MTGsymbol{3}{5}\MTGsymbol{W}{5},
	...
	back_description = {If a source an opponent controls would deal damage to you or a permanent you control, prevent 1 of that damage.\\
		Whenever you or another permanent you control becomes the target of a spell or ability an opponent controls, counter that spell or ability unless its controller pays \MTGsymbol{1}{3}.},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{U}{5}\MTGsymbol{R}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{B}{5},
	card_type = 传奇生物 — 人类／参谋,
	description = {鹏洛客共鸣（你每操控一个鹏洛客，此咒语便减少\MTGsymbol{1}{3}来施放。）\\
		飞行，警戒\\
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{R}{5}\MTGsymbol{R}{5},
...
\card
{
	...
	description = {卡恩的同兆须横置进战场。\\
		...
		\MTGsymbol{X}{3}，\MTGsymbol{T}{3}，放逐卡恩的同兆：消灭所有法术力值等于或小于X的非地永久物。只能于法术时机起动。},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5},
	card_type = 神器,
	description = {只要三定法球未横置，每个施放时要支付的法术力少于三点之咒语均须支付三点法术力来施放。（需额外支付的费用可以用任意颜色的法术力或无色法术力来支付。举例来说，要支付\MTGsymbol{1}{3}\MTGsymbol{B}{3}来施放的咒语，则改为要支付\MTGsymbol{2}{3}\MTGsymbol{B}{3}来施放。)},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Whenever a player casts a creature spell, that player sacrifices a permanent unless they pay \MTGsymbol{1}{3}.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Other enchantments have "At the beginning of your upkeep, sacrifice this enchantment unless you pay \MTGsymbol{2}{3}."},
	stax_type = 大礼拜堂/烟囱效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 结界,
	description = {对手施放的神器和结界咒语增加\MTGsymbol{2}{3}来施放。牺牲静寂灵气：消灭目标神器或结界。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
...
\card
{
	...
	description = {At the beginning of your upkeep, sacrifice Contamination unless you sacrifice a creature.\\
		If a land is tapped for mana, it produces \MTGsymbol{B}{3} instead of any other type and amount.},
	stax_type = 腥红之月效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{B}{5}\MTGsymbol{R}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {All artifacts have "At the beginning of your upkeep, sacrifice this artifact unless you pay \MTGsymbol{2}{3}."},
	stax_type = 大礼拜堂/烟囱效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{B/R}{5},
	card_type = 结界,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5},
	card_type = 结界,
	description = {对每个生物而言，除非其操控者为其支付\MTGsymbol{2}{3}，否则它不能攻击你。},
	stax_type = 攻击/格挡锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{B}{5},
	card_type = Enchantment,
	description = {White spells cost \MTGsymbol{3}{3} more to cast.\\
		Activated abilities of white enchantments cost \MTGsymbol{3}{3} more to activate.},
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Red creature spells and green creature spells cost \MTGsymbol{1}{3} more to cast.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5},
	card_type = World Enchantment,
	description = {Whenever a player casts an instant spell, counter it unless that player pays \MTGsymbol{X}{3}, where X is its mana value.},
	stax_type = 咒语税,
	is_in_restricted_list = RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {Phasing (This phases in or out before you untap during each of your untap steps. While it's phased out, it's treated as though it doesn't exist.)\\
		Creatures with flying can't attack or block, and their activated abilities with \MTGsymbol{T}{3} in their costs can't be activated.},
...
\card
{
	...
	description = {Blue creatures don't untap during their controllers' untap steps.\\
		At the beginning of each player's upkeep, that player may choose any number of tapped blue creatures they control and pay \MTGsymbol{4}{3} for each creature chosen this way. If the player does, untap those creatures.},
	stax_type = 冬之球效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {Creatures without flying don't untap during their controllers' untap steps.\\
		At the beginning of each player's upkeep, that player may choose any number of tapped creatures without flying they control and pay \MTGsymbol{2}{3} for each creature chosen this way. If the player does, untap those creatures.},
	stax_type = 冬之球效应,
	is_in_restricted_list = RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{U}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{1}{3}\MTGsymbol{U}{3}\MTGsymbol{U}{3} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)\\
		If tapped for mana, Plains produce \MTGsymbol{R}{3}, Swamps produce \MTGsymbol{G}{3}, Mountains produce \MTGsymbol{W}{3}, and Forests produce \MTGsymbol{B}{3} instead of any other type.},
	stax_type = 腥红之月效应,
	is_in_restricted_list = RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{U/B}{5}\MTGsymbol{U/B}{5},
	card_type = 传奇鹏洛客 ～安梭苛,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W/U}{5},
	card_type = 传奇鹏洛客 ～多温,
	description = {对手施放的神器、瞬间和法术咒语增加\MTGsymbol{1}{3}来施放。\\
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{U}{5},
	card_type = 传奇鹏洛客 — 泰菲力,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～猫／僧侣,
	description = {闪现\\
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 生物～天使,
	description = {飞行\\
		由你操控的其他非黑色生物得+1/+1。\\
...
\card
{
	...
	card_type = 生物 — 天使,
	description = {飞行\\
		只要什一税大天使未横置，对每个生物而言，除非其操控者为其支付\MTGsymbol{1}{3}，否则它不能攻击你或由你操控的鹏洛客。\\
		只要什一税大天使正进行攻击，对每个生物而言，除非其操控者为其支付\MTGsymbol{1}{3}，否则它不能进行阻挡。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = legal,
	legality / alchemy = legal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{B}{5}\MTGsymbol{G}{5}\MTGsymbol{U}{5},
	card_type = 传奇生物 ～龟／祭师,
...
\card
{
	...
	description = {飞行\\
		...
		对每个生物而言，除非其操控者为其支付\MTGsymbol{1}{3}，否则它不能攻击你或由你操控的鹏洛客。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 传奇生物 ～人类／士兵,
	description = {警戒\\
		对每个生物而言，除非其操控者为其支付\MTGsymbol{1}{3}，否则它不能攻击你或由你操控的鹏洛客。},
	stax_type = 攻击/格挡税,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5}\MTGsymbol{B}{5},
...
\mfcard
{
	...
	front_mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	front_card_type = 传奇生物 — 非瑞人／魔判官,
	front_description = {警戒\\
		每当一个由对手操控的来源对你或任一由你操控的永久物造成伤害时，除非该来源的操控者支付\MTGsymbol{1}{3}，否则其失去2点生命。\\
		\MTGsymbol{2}{3}\MTGsymbol{W}{3}，牺牲三个其他生物：放逐艾蕾侬，然后将它在其拥有者的操控下移回战场且已转化。只能于法术时机起动。},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{B}{5},
	card_type = 传奇结界生物～神,
	description = {不灭\\
		只要你的黑色献力小于五，厄睿柏斯便不是生物。（由你操控之永久物的法术力费用当中每含有一个\MTGsymbol{B}{3}，你的黑色献力就加一。）\\
		对手不能获得生命。\\
		\MTGsymbol{1}{3}\MTGsymbol{B}{3}，支付2点生命：抓一张牌。},
	stax_type = 获得生命锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5}\MTGsymbol{U}{5},
	card_type = 传奇生物 ～人类／参谋,
	description = {你施放的白色咒语减少\MTGsymbol{1}{3}来施放。\\
		你施放的蓝色咒语减少\MTGsymbol{1}{3}来施放。\\
		对手施放的咒语增加\MTGsymbol{1}{3}来施放。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{U}{5}\MTGsymbol{R}{5}\MTGsymbol{W}{5},
	card_type = 传奇生物 ～麒麟／精怪,
	description = {飞行，践踏\\
		你施放的咒语每有一个目标，便减少\MTGsymbol{1}{3}来施放。\\
		对手施放的咒语每有一个目标，便增加\MTGsymbol{1}{3}来施放。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {Green enchantment spells and white enchantment spells cost \MTGsymbol{2}{3} more to cast.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{U}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5},
	card_type = 神器生物 ～魔像,
	description = {非神器咒语增加\MTGsymbol{1}{3}来施放。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{W}{5},
	card_type = 生物～人类／法术师,
	description = {所有生物具有「在你的维持开始时，除非你支付\MTGsymbol{1}{3}，否则牺牲此生物。」},
	stax_type = 大礼拜堂/烟囱效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{R}{5}\MTGsymbol{G}{5}\MTGsymbol{W}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5}\MTGsymbol{B}{5},
	card_type = 生物 ～人类／浪客,
	description = {闪现\\
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{G}{5}\MTGsymbol{W}{5}\MTGsymbol{U}{5},
	card_type = 生物～天使,
	description = {飞行，警戒\\
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{R}{5}\MTGsymbol{R}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{W}{5}\MTGsymbol{B}{5}\MTGsymbol{G}{5},
...
\card
{
	...
	description = {Ward \MTGsymbol{2}{3}\\
...
\card
{
	...
	card_type = 生物 ～精怪,
	description = {飞行\\
		对每个生物而言，除非其操控者为其支付\MTGsymbol{2}{3}，否则它不能攻击你。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{G}{5}\MTGsymbol{W}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{1}{5}\MTGsymbol{B}{5}\MTGsymbol{R}{5}\MTGsymbol{G}{5},
	card_type = 传奇生物 ～凡尔西诺／祭师,
	description = {警戒\\
		牌手失去未用尽的法术力会使其失去等量的生命。\\
		\MTGsymbol{1}{3}，\MTGsymbol{T}{3}：每位牌手各加\MTGsymbol{B}{3}\MTGsymbol{R}{3}\MTGsymbol{G}{3}。},
	stax_type = 其他异能/效应税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {活动地板须横置进战场。\\
		生物须横置进战场。\\
		\MTGsymbol{2}{3}，\MTGsymbol{T}{3}，放逐活动地板：放逐所有未横置的生物。只能于法术时机起动。},
	stax_type = 眠梦法球效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = 普世结界,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{R}{5},
	card_type = Enchantment — Aura,
	description = {Enchant creature\\
		Cumulative upkeep \MTGsymbol{R}{3} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)\\
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{U}{3} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)\\
		Green creatures have "Cumulative upkeep \MTGsymbol{1}{3}."},
	stax_type = 大礼拜堂/烟囱效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Domain — Creatures can't attack you unless their controller pays \MTGsymbol{X}{3} for each creature they control that's attacking you, where X is the number of basic land types among lands you control.},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5}\MTGsymbol{B}{5},
	card_type = 结界,
...
\card
{
	...
	description = {Creatures don't untap during their controllers' untap steps.\\
		At the beginning of each player's upkeep, that player may choose any number of tapped nongreen creatures they control and pay \MTGsymbol{2}{3} for each creature chosen this way. If the player does, untap those creatures.},
	stax_type = 冬之球效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = Enchantment,
	description = {At the beginning of your upkeep, sacrifice Drought unless you pay \MTGsymbol{W}{3}\MTGsymbol{W}{3}.\\
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
	description = {Each artifact spell costs \MTGsymbol{1}{3} more to cast for each artifact its controller controls.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep—Pay \MTGsymbol{B}{3} and 1 life. (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)\\
		If a land is tapped for mana, it produces \MTGsymbol{B}{3} instead of any other type.},
	stax_type = 腥红之月效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {At the beginning of your upkeep, sacrifice Koskun Falls unless you tap an untapped creature you control.\\
		Creatures can't attack you unless their controller pays \MTGsymbol{2}{3} for each creature they control that's attacking you.},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{B}{5},
	card_type = World Enchantment,
	description = {Whenever a player casts a spell, counter it unless that player pays \MTGsymbol{3}{3}.},
	stax_type = 咒语税,
	is_in_restricted_list = RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {All creatures have "At the beginning of your upkeep, sacrifice this creature unless you pay \MTGsymbol{1}{3}."},
	stax_type = 大礼拜堂/烟囱效应,
	is_in_restricted_list = RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
	description = {Sorcery spells cost \MTGsymbol{3}{3} more to cast.},
	stax_type = 咒语锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{R}{5}\MTGsymbol{W}{5},
	card_type = 传奇生物～天使,
	description = {飞行\\
		牌手在战斗中不能施放咒语。\\
		\MTGsymbol{R}{3}：目标生物本回合若能攻击，则必须攻击。},
	stax_type = 止咒高僧效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～人类／法术师,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{B/R}{5}\MTGsymbol{B/R}{5},
	card_type = 生物～元素／骑士,
	description = {飞行\\
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5}\MTGsymbol{B}{5},
	card_type = 传奇生物 ～天使,
	description = {对此咒语而言，你不是支付等同于你本盘游戏中此前从统帅区施放过它之次数的\MTGsymbol{2}{3}，而是支付该次数的2点生命。\\
		飞行，系命\\
		每当任一牌手施放咒语时，其失去2点生命。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
...
\card
{
	...
	description = {死冥耶夫的力量等同于所有坟墓场中的生物牌数量。\\
		在每位牌手的维持开始时，该牌手弃一张牌。\\
		疯魔\MTGsymbol{1}{3}\MTGsymbol{B}{3}\MTGsymbol{B}{3}（如果你弃掉此牌，将之弃到放逐区。当你如此作时，支付其疯魔费用施放之，否则便将其置入你的坟墓场。）},
	stax_type = 手牌Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5}\MTGsymbol{B}{5}\MTGsymbol{R}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{R}{5}\MTGsymbol{R}{5},
	card_type = 生物 ～巨人／狂战士,
	description = {对手不能获得生命。\\
		在你的维持开始时，撼地狂汉向每位对手各造成2点伤害。此异能只有于撼地狂汉在战场时或于撼地狂汉在你坟墓场中且你操控巨人时才会触发。\\
		预示\MTGsymbol{2}{3}\MTGsymbol{R}{3}\MTGsymbol{R}{3}},
	stax_type = 获得生命锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{W}{5}\MTGsymbol{U}{5}\MTGsymbol{B}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 生物～象／法术师,
	description = {每当任一对手使用咒语时，除非该牌手支付\MTGsymbol{1}{3}，否则他牺牲一个永久物。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{2}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{B}{5}\MTGsymbol{R}{5},
	card_type = 生物～猎犬,
...
\mfcard
{
	...
	front_mana_cost = \MTGsymbol{5}{5},
	front_card_type = Creature — Avatar,
	front_description = {Whenever an opponent casts an instant or sorcery spell, they may pay \MTGsymbol{2}{3}. If they don't, you may copy that spell. You may choose new targets for the copy.},
	back_card_english_name = {Explore the Vastlands},
	back_card_chinese_name = {探索旷土},
	back_card_image = stx-6-explore-the-vastlands.png,
	back_mana_cost = \MTGsymbol{3}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5},
	card_type = Artifact,
	description = {Cumulative upkeep \MTGsymbol{3}{3} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)\\
		If tapped for mana, Plains produce \MTGsymbol{R}{3}, Islands produce \MTGsymbol{G}{3}, Swamps produce \MTGsymbol{W}{3}, Mountains produce \MTGsymbol{U}{3}, and Forests produce \MTGsymbol{B}{3} instead of any other type.},
	stax_type = 腥红之月效应,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{W/P}{5}\MTGsymbol{W/P}{5},
	card_type = 神器,
	description = {（\MTGsymbol{W/P}{3}可用\MTGsymbol{W}{3}或2点生命来支付。）\\
		对每个生物而言，除非其操控者为其支付\MTGsymbol{W/P}{3}，否则它不能攻击你或由你操控的鹏洛客。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\mfcard
{
	...
	front_mana_cost = \MTGsymbol{3}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	front_card_type = 神器,
	front_description = {当不稳雕符桥进战场时，若它经你施放，则为每位牌手各选择一个由其操控且力量等于或小于2的生物。然后消灭所有生物，但以此法选中的生物除外。\\
		以神器化炼\MTGsymbol{3}{3}\MTGsymbol{W}{3}\MTGsymbol{W}{3}（\MTGsymbol{3}{3}\MTGsymbol{W}{3}\MTGsymbol{W}{3}，放逐此神器，放逐另一个由你操控的神器或一张你坟墓场中的神器牌：将此牌在其拥有者的操控下移回且已转化。只能于法术时机化炼。）},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
	card_type = 结界,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{B}{5},
	card_type = Enchantment,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{U}{5},
	card_type = Enchantment,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{W}{5},
	card_type = 结界,
	description = {对每个生物而言，除非其操控者为其支付\MTGsymbol{X}{3}，否则它不能攻击你或由你操控的鹏洛客，X为由你操控的结界数量。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{R}{5},
	card_type = Enchantment,
	description = {Players can't gain life.\\
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{G}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～统领,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
	card_type = 传奇生物～吸血鬼,
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5}\MTGsymbol{W}{5},
	card_type = 生物 ～人类／士兵,
	description = {当米那斯提力斯斗士进战场时，你成为君主。\\
		在每位对手回合的战斗开始时，若你是君主，则该对手可以支付\MTGsymbol{X}{3}，X为其手牌数量。若其未如此作，则该对手本次战斗不能攻击你。},
	stax_type = 攻击/格挡税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5}\MTGsymbol{R}{5},
	card_type = 生物～恶魔,
	description = {飞行\\
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5}\MTGsymbol{B}{5},
	card_type = 结界生物 ～恶魔,
	description = {飞行\\
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{R}{5}\MTGsymbol{G}{5},
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{B}{5}\MTGsymbol{R}{5},
	card_type = 生物～恶魔,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = 传奇生物 ～非瑞人／魔判官,
	description = {践踏，敏捷\\
...
\card
{
	...
	mana_cost = \MTGsymbol{6}{5},
	card_type = Artifact,
	description = {Creature spells cost \MTGsymbol{2}{3} more to cast.},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{6}{5},
	card_type = 传奇神器,
	description = {对手施放的咒语增加\MTGsymbol{2}{3}来施放。\\
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{W/U}{5}\MTGsymbol{W/U}{5}\MTGsymbol{W/U}{5},
	card_type = 结界,
	description = {（\MTGsymbol{W/U}{3}可用\MTGsymbol{W}{3}或\MTGsymbol{U}{3}来支付。）\\
...
\card
{
	...
	mana_cost = \MTGsymbol{3}{5}\MTGsymbol{B}{5}\MTGsymbol{R}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
	description = {At the beginning of your upkeep, sacrifice Earthlink unless you pay \MTGsymbol{2}{3}.\\
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{W}{5}\MTGsymbol{B}{5},
	card_type = 结界,
	description = {由你操控的生物得+1/+1。\\
		由对手操控的生物得-1/-1。\\
		\MTGsymbol{2}{3}\MTGsymbol{W}{3}\MTGsymbol{B}{3}：将目标牌从任一对手的坟墓场放逐。如果它是生物牌，则你派出一个1/1，白黑双色，具飞行异能的精怪衍生生物。},
	stax_type = 生物Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	description = {在每位牌手的维持开始时，该牌手失去1点生命且弃一张牌。\\
		...
		疯魔\MTGsymbol{2}{3}\MTGsymbol{B}{3}\MTGsymbol{B}{3}（如果你弃掉此牌，可以改为使用它并支付其疯魔费用，而非直接将它置入你的坟墓场。）},
	stax_type = 手牌Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
	description = {At the beginning of your upkeep, sacrifice Nature's Wrath unless you pay \MTGsymbol{G}{3}.\\
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = Enchantment,
	description = {Cumulative upkeep \MTGsymbol{2}{3} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)\\
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{R}{5}\MTGsymbol{R}{5},
	card_type = Enchantment,
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 生物～天使,
	description = {飞行\\
		本回合施放过咒语的对手均不能以生物攻击。\\
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 生物～天使,
	description = {你可以从你的起手牌中展示此牌。 如果你如此作，当每位牌手施放他在本盘游戏中的第一个咒语时，除非该牌手支付\MTGsymbol{1}{3}，否则反击之。\\
		飞行\\
		每当任一对手施放咒语时，除非该牌手支付\MTGsymbol{1}{3}，否则反击之。},
	stax_type = 咒语税,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
	card_type = 传奇生物 ～非瑞人／魔判官,
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5}\MTGsymbol{R}{5}\MTGsymbol{W}{5},
	card_type = Creature — Alien Rhino Soldier,
	description = {Trample\\
		No more than one creature can attack you each combat.\\
		Suspend 6—\MTGsymbol{1}{3}\MTGsymbol{R}{3}\MTGsymbol{W}{3} (Rather than cast this card from your hand, you may pay \MTGsymbol{1}{3}\MTGsymbol{R}{3}\MTGsymbol{W}{3} and exile it with six time counters on it. At the beginning of your upkeep, remove a time counter. When the last is removed, you may cast it without paying its mana cost. It has haste.)},
	stax_type = 攻击/格挡锁,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
	card_type = 传奇生物 ～非瑞人／魔判官,
...
\card
{
	...
	description = {在每个结束步骤开始时，在每个不由你操控的生物上各放置一个黏菌指示物。\\
		...
		\MTGsymbol{U}{3}\MTGsymbol{B}{3}，牺牲一个蛞蝓：抓一张牌。},
	stax_type = 生物Hate,
	is_in_restricted_list = Not RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
...
\card
{
	...
	mana_cost = \MTGsymbol{6}{5}\MTGsymbol{B}{5}\MTGsymbol{B}{5},
	card_type = 生物 ～恶魔,
	description = {飞行\\
		所有对手都不能获得生命。\\
...
\card
{
	...
	mana_cost = \MTGsymbol{5}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
	card_type = 生物 ～海怪,
...
\card
{
	...
	mana_cost = \MTGsymbol{6}{5}\MTGsymbol{G}{5}\MTGsymbol{G}{5},
	card_type = 传奇生物 ～非瑞人／魔判官,
	description = {践踏\\
...
\card
{
	...
	mana_cost = \MTGsymbol{6}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5}\MTGsymbol{W}{5},
	card_type = 生物 — 统领,
	description = {飞行\\
		生物不能攻击你。},
	stax_type = 攻击/格挡锁,
...
\card
{
	...
	mana_cost = \MTGsymbol{8}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
	card_type = 传奇生物 ～非瑞人／魔判官,
	description = {闪现\\
		在你的结束步骤开始时，抓七张牌。\\
		每位对手的手牌上限均减少七张。},
...
\card
{
	...
	mana_cost = \MTGsymbol{4}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5}\MTGsymbol{U}{5},
	card_type = 传奇结界,
...
\card
{
	...
	mana_cost = \MTGsymbol{X}{5}\MTGsymbol{X}{5},
	card_type = 神器,
...
\card
{
	...
	description = {All creatures have "At the beginning of your upkeep, destroy this creature unless you pay \MTGsymbol{1}{3}."},
	stax_type = 大礼拜堂/烟囱效应,
	is_in_restricted_list = RL,
	legality / standard = notlegal,
	legality / alchemy = notlegal,
